            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                        <th style="padding: 16px; text-align: left; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase;">Descripción</th>
                        ...
                        <th style="padding: 16px; text-align: left; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase;">Coordinador</th>
                    ...
                    <?php else: ?>
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6;">
                            <td style="padding: 16px;">
                                <div style="font-weight: 600; color: #1f2937;"><?php echo htmlspecialchars($registro['coord_descripcion']); ?></div>
                            </td>
                            <td style="padding: 16px;">
                            ...
                            <td style="padding: 16px; color: #6b7280;">
                                <?php echo htmlspecialchars($registro['coord_nombre_coordinador'] ?? 'Sin asignar'); ?>
                            </td>
                            <td style="padding: 16px;">
