...
<div class="main-content">
    ...
    <div class="table-container">
        <div class="table-header">
            <h2>Listado de Coordinaciones</h2>
            <a href="crear.php" class="btn btn-primary">+ Nueva Coordinación</a>
        </div>
        <table>
            <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <button onclick="confirmarEliminacion(<?php echo $registro['id']; ?>, 'coordinacion')" class="btn btn-danger btn-sm">Eliminar</button>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
