...
<div class="main-content">
    ...
    <?php if (isset($_GET['msg'])): ?>
        <div class="alert alert-success" style="margin: 24px 32px;">
            <?php 
            if ($_GET['msg'] == 'creado') echo '✓ Detalle creado exitosamente';
            if ($_GET['msg'] == 'actualizado') echo '✓ Detalle actualizado exitosamente';
            if ($_GET['msg'] == 'eliminado') echo '✓ Detalle eliminado exitosamente';
            ?>
        </div>
    <?php endif; ?>
    ...
    <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; padding: 24px 32px;">
        <div style="background: white; padding: 20px; border-radius: 12px; border: 1px solid #e5e7eb;">
            <div style="font-size: 13px; color: #6b7280; margin-bottom: 8px;">Total Detalles</div>
            <div style="font-size: 32px; font-weight: 700; color: #6366f1;"><?php echo count($registros); ?></div>
        </div>
        <div style="background: white; padding: 20px; border-radius: 12px; border: 1px solid #e5e7eb;">
            <div style="font-size: 13px; color: #6b7280; margin-bottom: 8px;">Hoy</div>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                        ...
                        <th style="padding: 16px; text-align: left; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase;">Fecha</th>
                        <th style="padding: 16px; text-align: left; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase;">Hora Inicio</th>
                        <th style="padding: 16px; text-align: left; font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase;">Hora Fin</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 60px 20px; color: #6b7280;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 16px;">No hay detalles registrados</p>
                            <a href="crear.php" class="btn btn-primary btn-sm">Crear Primer Detalle</a>
                        </td>
                    </tr>
                    <?php else: ?>
                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6;">
                            <td style="padding: 16px;">
                                <strong style="color: #6366f1; font-size: 14px;"><?php echo $registro['ficha_numero']; ?></strong>
                            </td>
                            <td style="padding: 16px;">
